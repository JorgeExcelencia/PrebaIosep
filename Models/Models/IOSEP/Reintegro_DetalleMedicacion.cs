...
{
    public partial class Reintegro_DetalleMedicacion
    {
        public int ReintegroDetalleMedicacionID { get; set; }
        ...
        public virtual Prestadore? IdFarmaciaNavigation { get; set; }
        public virtual Reintegro_DetalleFactura ReintegroDetalleFactura { get; set; } = null!;
    }
}
